...
public:
   ...
   [[eosio::action]] void swapgastoken(name new_token_contract, symbol new_symbol, name swap_dest_account, string swap_memo);
   [[eosio::action]] void migratebal(name from_name, int limit);
