...
struct [[eosio::table]] [[eosio::contract("evm_contract")]] tokenconfig
{
    eosio::name   contract;
    eosio::symbol symbol;
    uint64_t      minimum_natively_representable = 0;

    EOSLIB_SERIALIZE(tokenconfig, (contract)(symbol)(minimum_natively_representable));
};
